...
https://www.wikidata.org/wiki/Q107791631
...
**Sample 2**: Face recognition on multiple cover thumbnail images using OpenCV image recognition package (https://opencv.org/) .
```
...
![alt text](https://mirrors.creativecommons.org/presskit/buttons/88x31/png/by-nc.png "CC BY-NC License")
